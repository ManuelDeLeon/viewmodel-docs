...
type c:\Meteor\viewmodel-explorer\package.js.tmp|replace.bat "debugOnly: true" "debugOnly: false" c:\Meteor\viewmodel-explorer\package.js.tmp>c:\Meteor\viewmodel-explorer\package.js
